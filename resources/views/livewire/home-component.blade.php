                        ...
                        <div class="row align-items-center slider-animated-1">
                            ...
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated slider-1-1" src="{{ asset('assets/imgs') }}/{{ $slide->image }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    ...
                                    <div class="product-action-1">
                                        ...
                                        {{-- @if ($wishitems->contains($fproduct->id))
                                        <a aria-label="Remove From Wishlist" class="action-btn hover-up wishlisted" href="#" Wire:click.prevent="removeWishlist({{ $fproduct->id }})"><i class="fi-rs-heart"></i></a>
                                        @else
