                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> We found <strong class="text-brand">{{ $products->total() }}</strong> Products from <strong class="text-brand">{{ $category_name }}</strong> !</p>
                            </div>
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a href="#" class="{{ $orderBy=='Short By Latest' ? 'active': ''}}" wire:click.prevent="changeOrderBy('Short By Latest')">Short By Latest</a></li>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                ...
                                <li><a href="{{ route('product.category',['slug'=>$category->slug]) }}">{{ $category->category }}</a></li>
                                @endforeach
